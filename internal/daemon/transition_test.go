...
func (*transitionRecorder) Commit(context.Context, string, string, ...string) error { return nil }

func (*transitionRecorder) RemoveImage(context.Context, string) error { return nil }
